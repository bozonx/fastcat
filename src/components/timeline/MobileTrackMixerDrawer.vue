...
<template>
  ...
  >
    <div v-if="selectedTrackForProperties" class="flex flex-col animate-in fade-in slide-in-from-right-4 duration-200">
    ...
    <div v-else class="px-4 py-4 animate-in fade-in slide-in-from-left-4 duration-200">
      <!-- Master Volume -->
