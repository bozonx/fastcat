...
export const TextClipStyleSchema = z.object({
  ...
  textShadowAlpha: z.number().optional(),
  textShadowBlur: z.number().optional(),
  textShadowSpread: z.number().optional(),
  ...
  backgroundShadowEnabled: z.boolean().optional(),
  backgroundShadowColor: z.string().optional(),
  backgroundShadowAlpha: z.number().optional(),
  backgroundShadowBlur: z.number().optional(),
  backgroundShadowSpread: z.number().optional(),
  backgroundShadowOffsetX: z.number().optional(),
  backgroundShadowOffsetY: z.number().optional(),
