...
export const DEFAULT_HOTKEYS: HotkeyRegistry = {
  commands: [
    ...
    { id: 'general.volumeDown', groupId: 'timelineMonitorGlobal', title: 'Decrease monitor volume' },
    { id: 'general.snapshot', groupId: 'timelineMonitorGlobal', title: 'Create snapshot from monitor' },
    ...
    { id: 'timeline.setSelectionOut', groupId: 'timelineMonitorGlobal', title: 'Set selection Out' },
    ...
    { id: 'playback.toggle1', groupId: 'timelineMonitorGlobal', title: 'Toggle playback (secondary)' },
    ...
    { id: 'playback.jumpPrevBoundary', groupId: 'timelineMonitorGlobal', title: 'Jump to previous edit point' },
    { id: 'playback.jumpNextBoundary', groupId: 'timelineMonitorGlobal', title: 'Jump to next edit point' },
    {
