...
export const DEFAULT_HOTKEYS: HotkeyRegistry = {
  ...
  bindings: {
    ...
    'general.rename': ['F2'],
    'general.save': [`${Mod}+S`],
    'general.newTimeline': ['Shift+N'],

    'general.mute': [`${Mod}+Q`],
    'general.volumeUp': ['Shift+='],
    'general.volumeDown': ['Shift+-'],
    ...
    'timeline.splitAllAtPlayhead': ['Shift+T'],
    ...
    'timeline.toggleSoloTrack': ['Shift+S'],
    ...
    'timeline.toggleWaveformMode': [','],
    'timeline.toggleShowWaveform': ['.'],
    'timeline.toggleShowThumbnails': ['Shift+X'],
    ...
    'playback.jumpNextBoundaryTrack': ['Shift+G', 'Shift+ArrowDown'],
  },
};
