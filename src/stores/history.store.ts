...
const COMMAND_LABELS: Record<TimelineCommand['type'], string> = {
  ...
  move_item: 'granVideoEditor.timeline.history.moveItem',
  move_items: 'granVideoEditor.timeline.history.moveItems',
  move_item_to_track: 'granVideoEditor.timeline.history.moveItem',
  trim_item: 'Trim clip',
