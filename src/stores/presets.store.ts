...
export const usePresetsStore = defineStore('presets', () => {
  ...
  watch(
    [effectsStandardCollapsed, effectsCustomCollapsed, transitionsStandardCollapsed, transitionsCustomCollapsed],
    () => {
      localStorage.setItem('gran-presets-collapsed', JSON.stringify({
  ...
  function saveAsPreset(category: 'effect' | 'transition', baseType: string, name: string, params: Record<string, any>) {
