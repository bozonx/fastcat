import { secondsToTicks, TICKS_PER_MILLISECOND, ticksToSeconds } from '~/utils/time';
...
const PLAYING_SEEK_IGNORE_TICKS = 200 * TICKS_PER_MILLISECOND;
...
export function shouldSyncNativeMonitorTime(params: {
  ...
  if (params.diffTicks < TICKS_PER_MILLISECOND / 2) return false;
  if (params.diffTicks > 100 * TICKS_PER_MILLISECOND) return true;
