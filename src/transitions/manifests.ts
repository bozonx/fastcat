...
export const transitionManifests: TransitionManifest[] = [
  {
    ...
    defaultDurationTicks: TICKS_PER_SECOND / 2,
    defaultParams: {},
    renderMode: 'shader',
    renderer: 'wgpu',
  ...
  },
  {
    ...
    defaultDurationTicks: (3 * TICKS_PER_SECOND) / 5,
  ...
  },
  {
    ...
    defaultDurationTicks: (7 * TICKS_PER_SECOND) / 10,
  ...
  },
  {
    ...
    defaultDurationTicks: TICKS_PER_SECOND,
    defaultParams: {
      angle: 0,
      stripCount: 10,
      blur: 0,
