  ...
  controls: [
    {
      ...
      options: [
        {
          label: 'None',
          labelKey: 'fastcat.effects.video.colorMatrix.options.none',
          value: 'none',
        },
        {
          label: 'Sepia',
          labelKey: 'fastcat.effects.video.colorMatrix.options.sepia',
          value: 'sepia',
        },
        {
          label: 'Negative',
          labelKey: 'fastcat.effects.video.colorMatrix.options.negative',
          value: 'negative',
        },
        {
          label: 'Grayscale',
          labelKey: 'fastcat.effects.video.colorMatrix.options.blackAndWhite',
          value: 'blackAndWhite',
        },
        {
          label: 'Brownie',
          labelKey: 'fastcat.effects.video.colorMatrix.options.browni',
          value: 'browni',
        },
        {
          label: 'Vintage',
          labelKey: 'fastcat.effects.video.colorMatrix.options.vintage',
          value: 'vintage',
        },
        {
          label: 'Kodachrome',
          labelKey: 'fastcat.effects.video.colorMatrix.options.kodachrome',
          value: 'kodachrome',
        },
        {
          label: 'Technicolor',
          labelKey: 'fastcat.effects.video.colorMatrix.options.technicolor',
          value: 'technicolor',
        },
        {
          label: 'Polaroid',
          labelKey: 'fastcat.effects.video.colorMatrix.options.polaroid',
          value: 'polaroid',
        },
