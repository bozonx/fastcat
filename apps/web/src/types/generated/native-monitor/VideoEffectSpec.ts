...
export type VideoEffectSpec =
  ...
  | { type: 'gaussian-blur-pixels'; radius: number; mix: number }
  ...
  | { type: 'sharpen'; amount: number; mix: number }
  | { type: 'pixelate'; size: number; mix: number }
  | {
      type: 'bloom';
      threshold: number;
      strength: number;
  ...
  | { type: 'vignette'; strength: number; radius: number; softness: number; mix: number }
  | { type: 'noise'; amount: number; seed: number; noise_type: string; scale: number; mix: number }
  | { type: 'chromatic-aberration'; amount: number; angle_deg: number; mix: number }
  | {
      type: 'color-tone';
