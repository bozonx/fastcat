...
describe('DEFAULT_USER_SETTINGS', () => {
  ...
  it('has timeline defaults', () => {
    ...
    expect(DEFAULT_USER_SETTINGS.timeline.defaultAudioFadeDurationTicks).toBe(254_016_000_000);
    expect(DEFAULT_USER_SETTINGS.timeline.defaultTransitionDurationTicks).toBe(508_032_000_000);
  });
