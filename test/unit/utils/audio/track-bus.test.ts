...
describe('buildEffectiveAudioClipItems', () => {
      ...
      items: [
        {
          ...
          trackId: 'a1',
          name: 'clip1',
          timelineRange: { startUs: 0, durationUs: TICKS_PER_SECOND },
          sourceRange: { startUs: 0, durationUs: TICKS_PER_SECOND },
          source: { path: 'audio/y.mp3' },
          sourceDurationUs: TICKS_PER_SECOND,
          audioGain: 2,
        },
      ],
      audioGain: 1.5,
  ...
  it('uses default clip audio parameters when the clip audio block is disabled', () => {
    ...
    expect(item.audioFadeInUs).toBe(100_000 * TICKS_PER_MICROSECOND);
  });
    ...
    const videoTrack = {
      ...
      items: [
        ...
        },
        {
          ...
          trackId: 'v1',
          name: 'image2',
          timelineRange: { startUs: TICKS_PER_SECOND, durationUs: TICKS_PER_SECOND },
          sourceRange: { startUs: 0, durationUs: TICKS_PER_SECOND },
        ...
        },
        {
          ...
          trackId: 'v1',
          name: 'video1',
          timelineRange: { startUs: 2 * TICKS_PER_SECOND, durationUs: TICKS_PER_SECOND },
          sourceRange: { startUs: 0, durationUs: TICKS_PER_SECOND },
          source: { path: 'video/x.mp4' },
          sourceDurationUs: TICKS_PER_SECOND,
          audioGain: 1,
