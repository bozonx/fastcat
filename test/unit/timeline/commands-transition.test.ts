...
describe('timeline/commands update_clip_transition', () => {
  it('sets transitionOut on a clip', () => {
    ...
    const next = applyTimelineCommand(doc, {
      ...
      trackId: 'v1',
      itemId: 'c1',
      transitionOut: { type: 'dissolve', durationTicks: 127_008_000_000 },
    }).next;
  ...
  it('sets transitionIn on a clip', () => {
    ...
    const next = applyTimelineCommand(doc, {
      ...
      trackId: 'v1',
      itemId: 'c1',
      transitionIn: { type: 'dissolve', durationTicks: 76_204_800_000 },
    }).next;
  ...
  it('keeps clip geometry unchanged and does not mirror to adjacent clip when setting transitionOut on a cut', () => {
    ...
    const next = applyTimelineCommand(doc, {
      ...
      trackId: 'v1',
      itemId: 'c1',
      transitionOut: { type: 'dissolve', durationTicks: 508_032_000_000 },
    }).next;
    ...
    expect(nextLeft.timelineRange.durationTicks).toBe(1_270_080_000_000);
    expect(nextRight.timelineRange.startTicks).toBe(1_270_080_000_000);
    expect(nextRight.timelineRange.durationTicks).toBe(1_270_080_000_000);
  ...
  it('updates only the target clip when changing transition duration on a cut', () => {
    const left = {
      ...
      trackId: 'v1',
      sourceDurationTicks: 2_540_160_000_000,
      sourceRange: { startTicks: 0, durationTicks: 1_778_112_000_000 },
      timelineRange: { startTicks: 0, durationTicks: 1_778_112_000_000 },
      transitionOut: { type: 'dissolve', durationTicks: 508_032_000_000 },
    };
    const right = {
      ...baseClip,
      ...
      transitionIn: { type: 'dissolve', durationTicks: 508_032_000_000 },
    };
    ...
    const next = applyTimelineCommand(doc, {
      ...
      trackId: 'v1',
      itemId: 'c1',
      transitionOut: { type: 'dissolve', durationTicks: 533_433_600_000 },
    }).next;
    ...
    expect(nextLeft.timelineRange.durationTicks).toBe(1_778_112_000_000);
    expect(nextLeft.transitionOut.durationTicks).toBe(533_433_600_000);
    expect(nextRight.transitionIn?.durationTicks).toBe(508_032_000_000);
  });
  ...
  it('clamps the changed edge against the opposite edge without resizing it', () => {
    ...
    const next = applyTimelineCommand(doc, {
      ...
      trackId: 'v1',
      itemId: 'c1',
      transitionIn: { type: 'dissolve', durationTicks: 1_016_064_000_000 },
    }).next;
    ...
    expect(nextClip.transitionIn.durationTicks).toBe(508_032_000_000);
    expect(nextClip.transitionOut.durationTicks).toBe(762_048_000_000);
