...
- Web preview and Tauri native rendering/export use the same transition manifests, normalized parameters, WGSL shaders, and transition specs from `src/transitions/manifests.ts`. The previous Pixi-only transition implementations have been removed.
