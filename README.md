...
- Set `FASTCAT_RENDER_TIMING=1` when running the Tauri app to log native compositor stage timings (`materialize`, `build_vello`, `render`, total) for preview and offscreen pixel renders.
